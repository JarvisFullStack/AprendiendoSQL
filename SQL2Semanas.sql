...
INSERT INTO agenda(nombre,apellido,domicilio,telefono) VALUES('Luis','Lopez','Guadalajara','9999999999');
INSERT INTO agenda(nombre,apellido,domicilio,telefono) VALUES('Maria','Burgos','Alaska','666666666');
SELECT * FROM agenda;
if object_id ('agenda') IS NOT NULL
    DROP TABLE agenda;
DROP TABLE agenda;
